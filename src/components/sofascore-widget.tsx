  ...
  return (
    <div className="mx-auto w-full max-w-[768px]">
      ...
      <div className="text-xs font-sans text-left mt-1 text-muted-foreground">
        Standings provided by <a target="_blank" rel="noopener noreferrer" href="https://www.sofascore.com/tournament/football/brazil/brasileirao-serie-a/83#id:72034" className="underline text-primary">Sofascore</a>
      </div>
    </div>
  );
}
